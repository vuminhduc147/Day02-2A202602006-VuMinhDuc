...
| 5   | Nguyễn Thế Khải | 2A202601099 | Thành viên |
| 6   | Nguyễn Kim Trung Đức | 2A202601325 | Thành viên |
| 7   | Nguyễn Việt Thắng | 2A202601321 | Thành viên |
| 8   | Vũ Minh Đức | 2A202602006 | Thành viên |
| 9   | Lê Hồng Đức | 2A202601313 | Thành viên |
| 10  | Nguyễn Đức Thiện | 2A202601415 | Thành viên |
| 11  | Kim Duy Hưng | 2A202501763 | Thành viên |
| 12  | Nguyễn Hữu Kiên | 2A202601033 | Thành viên |
...
| Mức | Candidate | Vì sao |
|---|---|---|
| **Khá tin được** | 1, 5, 6 | Người trình bày trực tiếp làm việc đó và có mốc thời gian cụ thể; #6 còn đếm được từ lịch sử Discord |
...
|---|---|---|---|
| **A. Tổng hợp định kỳ thành sản phẩm báo cáo** | 1, 4 | Gom dữ liệu rải rác theo chu kỳ cố định rồi biến thành văn bản hoặc slide trình bày | Nghẽn giống nhau: không phải ở khâu gom mà ở khâu diễn đạt thành narrative |
| **B. Trả lời lặp lại / đi tìm ngữ cảnh đã có** | 6, 10 | Câu trả lời đã tồn tại đâu đó (lịch sử chat, code, PR cũ) nhưng không tra ra được nên phải hỏi người | Cả hai đều tốn thời gian của **hai người**: người hỏi bị block, người trả lời bị ngắt mạch |
| **C. Biến tài liệu thô thành công cụ học tập** | 8, 11 | Đã có nguyên liệu học nhưng thiếu bước chuyển thành thứ dùng để ôn hoặc đi theo được | #11 mơ hồ hơn hẳn #8: "lộ trình phù hợp" không có tiêu chí đúng/sai rõ ràng |
| **D. Đối chiếu khối lượng lớn theo bộ tiêu chí có sẵn** | 2, 5, 12 | Lặp lại một phép kiểm tra trên rất nhiều đơn vị (học sinh / CV / chi tiết bản vẽ) dựa trên tiêu chuẩn đã định trước | Độ mơ hồ thấp → Rule có thể đã đủ. Nhưng #5 có rủi ro thiên lệch khi loại ứng viên, cần người kiểm tra |
| **E. Theo dõi dữ liệu cá nhân rải rác nhiều nơi** | 3, 7 | Thông tin (giao dịch, ngày hết hạn) nằm ở nhiều nền tảng, không có chỗ tổng hợp nên bị bỏ sót | Phần lớn giải được bằng Rule và tự động hoá, chỗ cho AI khá hẹp |
| **F. Không gom được** | 9 | Pipeline đa phương tiện nhiều bước nối tiếp, bước sau phụ thuộc kết quả bước trước | Đứng một mình, không trùng pattern với candidate nào khác |

**Nhận xét sau khi cluster:**

- Cụm **B** và **D** là hai cụm đông và có pattern chặt nhất. Cụm B nổi bật vì chi phí rơi vào hai người cùng lúc; cụm D nổi bật vì khối lượng lớn và tiêu chí rõ.
- Ba candidate cần viết lại vì đang mô tả **giải pháp thay vì vấn đề** — nhóm đã sửa lại trước khi đưa vào bảng trên:
  - #10 ban đầu ghi *"tạo agent framework cho người mới vào codebase"* → đó là giải pháp; vấn đề thật là người mới mất nhiều giờ mới hiểu đủ để bắt đầu task
  - #8 ban đầu kèm luôn *"AI tạo câu hỏi trắc nghiệm theo format đề"* → tách phần giải pháp ra khỏi mô tả vấn đề
  - #11 ban đầu ghi *"cần tài liệu và lộ trình phù hợp"* → đó là thứ mong muốn; vấn đề thật là không biết chọn và sắp thứ tự tài liệu
- Đây chính là bẫy solution-first mà lab cảnh báo: mô tả vấn đề bằng giải pháp thì mọi so sánh Rule / Workflow / Agent sau đó đều vô nghĩa, vì đáp án đã bị chốt sẵn từ đầu.
...
|---|---:|---|---|---|
| Quick interview | 4 | 4/4 sinh viên dành từ 3-5 tiếng/môn trước kỳ thi để đọc lại slide; 3/4 thừa nhận họ bị bí khi tự suy nghĩ câu hỏi ôn tập chất lượng | 1 bạn nói thường xin đề cương cũ từ khóa trên nên không tự tạo quiz | Thu hẹp problem: Không làm công cụ đọc slide chung chung, mà tập trung vào "tạo bộ Quiz cá nhân hóa sát theo đúng Slide bài giảng kỳ này của giảng viên". |
| Mini poll | 10 | 8/10 sinh viên xác nhận bước tốn thời gian nhất là đọc lướt lại slide và cố nhớ kiến thức thô mà không có bộ Quiz tự kiểm tra. | 2/10 từng dùng Anki thủ công nhưng than thở tạo thẻ quá mất thời gian (2 tiếng/chương). | Thêm phương án thay thế non-AI: Dùng đề cương khóa trên + làm thẻ Anki thủ công. |

Insight sau validation:

```text
Pain thật không nằm ở việc "tải slide về" hay "đọc lướt", mà nằm ở bước biến hàng trăm trang slide lý thuyết thô thành bộ câu hỏi Quiz tự kiểm tra (active recall) để ôn tập đúng trọng tâm.
```
...
Nhóm tìm hiểu các hướng đi và sản phẩm đã có sẵn trên thị trường:
...
```text
CURRENT STATE — 6 bước, 180 phút / môn

[1 Tải 10-12 file slide PDF từ LMS: 10']
→ [2 Đọc lướt lọc kiến thức chính: 60']
→ [3 Ghi chép Study Guide vào Notion/Docs: 50']
→ [4 Tự tạo 20-30 câu hỏi Quiz ôn tập: 50']  <-- BOTTLENECK (Bí câu hỏi, tạo câu quá dễ/lặp)
→ [5 Tự trả lời Quiz & dò đáp án thủ công: 10']
→ [6 Ôn tập và học thuộc: 0' (chưa kịp học vì hết thời gian)]

FUTURE STATE — 5 bước, 35 phút / môn

[1 Upload slide PDF vào tool: 2']                         -- Rule / PDF Parser
→ [2 AI phân tích & trích xuất key concepts: 3']          -- AI Workflow Step
→ [3 AI draft bộ 30 câu Quiz + đáp án & số trang slide: 2'] -- AI Workflow Step
→ [4 Sinh viên review & kiểm tra đối soát với slide: 15']  -- HUMAN BOUNDARY (Kiểm soát chất lượng)
→ [5 Sinh viên làm Quiz & tự ôn tập (Active Recall): 13']   -- Sinh viên tự học

Fallback:
AI sinh câu hỏi lệch nội dung slide hoặc đáp án sai → Sinh viên gắn cờ câu hỏi đó, AI sinh lại câu thay thế từ đúng số trang slide được chỉ định.

Bottleneck mới:
Sinh viên review & kiểm tra đối soát Quiz với slide (15 phút). Đây là bottleneck chấp nhận được vì giữ vai trò chốt chặn chất lượng kiến thức trước khi học.
```
...
|---|---:|---:|---|
| Tổng thời gian chuẩn bị | 180 phút | 35 phút | Giảm ~80% thời gian chuẩn bị tài liệu |
| Số bước | 6 | 5 | Rút ngắn quy trình chuẩn bị |
| Bước thủ công | 6/6 | 2/5 | Sinh viên chỉ review và tiến hành học |
| Bottleneck chính | Tự nghĩ câu hỏi Quiz | Review & đối soát Quiz | Human boundary kiểm soát chất lượng |
| Risk mới | Không có lỗi ảo giác AI | Có risk AI tạo câu hỏi/đáp án sai | Cần bước review đối soát số trang slide |
...
| **Boundary** | AI không làm bài thi thay sinh viên; không bịa kiến thức ngoài slide; không thay sinh viên ghi nhớ; chỉ dùng dữ liệu từ file slide được cung cấp. |
...
- Bước trích xuất text từ slide dùng Rule/PDF Parser đơn giản.
- AI vượt trội ở khả năng đọc hiểu tài liệu dài và sinh câu hỏi trắc nghiệm đúng định dạng.
- Quy trình ôn tập mang tính tuyến tính, sinh viên vẫn làm chủ bước kiểm tra chất lượng (review) và học thật.
- Chưa cần Agent vì không cần hệ thống tự động đăng nhập LMS hay tự ra quyết định phức tạp.
...
- Dùng tài liệu mẫu là 3 file slide PDF của 1 môn học vừa học tuần trước.
- Chạy workflow bán thủ công: Copy/Upload slide vào prompt chuẩn (Prompt template sinh Quiz có trích dẫn trang).
- AI sinh 20 câu hỏi trắc nghiệm kèm đáp án và số trang reference.
- Sinh viên làm thử, đo thời gian review và kiểm tra độ chính xác đáp án so với slide.
...
- Problem rất thực tế với sinh viên, workflow 5 bước tuyến tính cực kỳ rõ ràng.
- Đã xác định rõ non-AI components (PDF Parser) và AI components (Generation & Summarization).
- Ranh giới con người (Human Boundary) rõ: sinh viên bắt buộc review đối soát trang slide trước khi học.
- Dễ dàng triển khai thử nghiệm ngay trong phạm vi buổi lab bằng Prompting/Workflow đơn giản.
